...
export const generatePresignedUrl = async (objectName, expiry = 3600) => {
...
export const generateAvatarUploadData = async (userId) => {
...
export const validateAvatarObjectName = (userId, objectName) => {
