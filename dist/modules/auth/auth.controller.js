...
import { emailVerificationSchema, loginSchema, registerSchema, } from './auth.schema.js';
...
export const register = async (req, res, next) => {
    try {
        ...
        const user = await userService.register(validatedData.email, validatedData.password, validatedData.name);
...
export const login = async (req, res, next) => {
    try {
        ...
        const { user, sessionId } = await userService.login(validatedData.email, validatedData.password, req.ip);
