...
import { authenticate, sessionMiddleware, } from '../../core/middleware/middleware.js';
import { getCurrentUser, login, logout, register, resendVerificationHandler, verifyEmailHandler, } from './auth.controller.js';
 ...
 */
router.post('/resend-verification', authenticate, verificationLimiter, resendVerificationHandler);
