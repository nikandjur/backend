 ...
 */
router.post('/', authenticate, validate(postSchema.create, 'body'), postController.createPost);
/**
 * @swagger
 * /api/posts/search:
 *   get:
 ...
 */
router.patch('/:id', authenticate, validate(postSchema.create.partial()), postController.updatePost);
/**
 * @swagger
 * /api/posts/{id}:
 *   delete:
